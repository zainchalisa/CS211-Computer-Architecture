...
void recursiveMatTrans (
    ...
    if (n<=2) { // base case
        ...
        recursiveMatTrans ( global_n, n>>1, A, offset_row_A,offset_col_A,B, offset_row_B,offset_col_B); // box 1
        recursiveMatTrans ( global_n, n>>1, A, offset_row_A,offset_col_A + (n/2),B, offset_row_B + (n/2),offset_col_B); // box 2
        recursiveMatTrans ( global_n, n>>1, A, offset_row_A + (n/2),offset_col_A,B, offset_row_B,offset_col_B + (n/2)); // box 3
        recursiveMatTrans ( global_n, n>>1, A, offset_row_A+ (n/2),offset_col_A + (n/2),B, offset_row_B+ (n/2),offset_col_B  + (n/2)); // box 4
